...
If your authenticator application only allows 6 or 8 digits (like [FreeOTP](https://dan.hersam.com/tools/gen-qr-code.html), choose 8 digits and use the last 7 digits for your code.
